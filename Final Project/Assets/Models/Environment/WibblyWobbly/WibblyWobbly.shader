...
Properties {
    ...
    _Cutoff ("Alpha cutoff", Range(0,10)) = 0.5
    _ShakeDisplacement ("Displacement", Range (0, 10.0)) = 1.0
    _ShakeTime ("Shake Time", Range (0, 10.0)) = 1.0
    _ShakeWindspeed ("Shake Windspeed", Range (-10, 10.0)) = 1.0
